...
Component 'Camera':
	role: ccd
	affects:
	hwVersion (RO Attribute)	value: firmware: 23.10.19.12597
	shape (RO Attribute)	value: (1025, 1275, 65536)
	swVersion (RO Attribute)	value: 3.15.30086.0
	transpose (RO Attribute)	value: (-2, 1)
	binning (Vigilant Attribute)	 value: (1, 1) (unit: px) (range: (1, 1) → (2046, 227))
	dependencies (Vigilant Attribute)	 value: {}
	depthOfField (RO Vigilant Attribute)	 value: 9.561011904761904e-07 (unit: m) (range: 0 → 1000000000.0)
	exposureTime (Vigilant Attribute)	 value: 0.1 (unit: s) (range: 2.64e-05 → 600.0)
	fanSpeed (Vigilant Attribute)	 value: 0.0 (range: 0.0 → 1.0)
	gain (Vigilant Attribute)	 value: 1.1 (choices: 1: '12-bit (low noise)', 1.1: '16-bit (high dynamic range)', 20: '11-bit (high speed)')
	pixelSize (RO Vigilant Attribute)	 value: (6.5e-06, 6.5e-06) (unit: m)
	pointSpreadFunctionSize (RO Vigilant Attribute)	 value: 1.9595462675147466 (unit: px) (range: 0 → 1000000000.0)
	readoutRate (Vigilant Attribute)	 value: 180000000.0 (unit: Hz) (choices: 180000000.0, 310000000.0, 570000000.0)
	resolution (Vigilant Attribute)	 value: (1025, 1275) (unit: px) (range: (1, 1) → (1025, 1275))
	state (RO Vigilant Attribute)	 value: running
	targetTemperature (Vigilant Attribute)	 value: -45.0 (unit: °C) (range: -45.0 → 25)
	temperature (RO Vigilant Attribute)	 value: -44.382728576660156 (unit: °C)
	translation (Vigilant Attribute)	 value: (0, 0) (unit: px) (range: (-1022, -1023) → (1022, 1023))
	data (Data-flow)
	softwareTrigger (Event)
	Metadata:
		HW_NAME: 'Andor SONA-4BV6U (s/n: CSC-01003)'
		SW_VERSION: '3.15.30086.0'
		HW_VERSION: 'firmware: 23.10.19.12597'
		DET_TYPE: 'Detector integrating'
		SENSOR_SIZE: (2046, 2048)
		SENSOR_PIXEL_SIZE: (6.5e-06, 6.5e-06)
		SENSOR_TEMP: -44.382728576660156
		'Filter': 'Spurious noise filter'
		ROTATION: -0.099484
		IN_WL: (0, 0)
		LIGHT_POWER: 0.0
		LENS_NAME: 'Optical Objective'
		PIXEL_SIZE: (7.738095238095237e-08, 7.738095238095237e-08)
		LENS_MAG: 84.0
		LENS_NA: 0.8
		LENS_RI: 1.0
		OUT_WL: 'pass-through'
...
Component 'Optical Focus':
	...
	dependencies (Vigilant Attribute)	 value: {}
	position (RO Vigilant Attribute)	 value: {'z': -0.011000099239}
